...
<Dsl dslVersion="1.0.0.0" Id="108ced64-5475-4baa-bebc-6f5be3107d9e" Description="Description for Microsoft.Practices.ServiceFactory.ServiceContracts.ServiceContractDsl" Name="ServiceContractDsl" DisplayName="Service Contract Model" Namespace="Microsoft.Practices.ServiceFactory.ServiceContracts" ProductName="Web Service Software Factory: Modeling Edition" CompanyName="Microsoft PLK" PackageGuid="43805256-e844-436e-8835-035cc972a441" PackageNamespace="Microsoft.Practices.ServiceFactory.ServiceContracts" xmlns="http://schemas.microsoft.com/VisualStudio/2005/DslTools/DslDefinitionModel">
  <Classes>
        ...
        <DomainProperty Id="2243a296-c566-42fb-8052-35f0a291249e" Description="A cross-model reference to the associated data contract type on the data contract model." Name="Type" DisplayName="Type" Category="General">
          <Attributes>
            ...
            <ClrAttribute Name="Microsoft.Practices.Modeling.Dsl.Service.TargetClass">
              <Parameters>
                <AttributeParameter Value="@&quot;Microsoft.Practices.ServiceFactory.DataContracts\DataContractBase&quot;" />
              </Parameters>
            </ClrAttribute>
          </Attributes>
          <Type>
      ...
      <Properties>
        <DomainProperty Id="5f0afdf3-b096-46b0-b311-729372d83358" Description="A cross-model reference to the associated data contract type on the data contract model." Name="Type" DisplayName="Type" Category="General">
          <Attributes>
            ...
            <ClrAttribute Name="Microsoft.Practices.Modeling.Dsl.Service.TargetClass">
              <Parameters>
                <AttributeParameter Value="@&quot;Microsoft.Practices.ServiceFactory.DataContracts\FaultContract&quot;" />
              </Parameters>
            </ClrAttribute>
          </Attributes>
          <Type>
  ...
  <Relationships>
    <DomainRelationship Id="fc321a85-682a-47c1-ab36-ebdd439b3c7a" Description="Embedding relationship between the Model and Elements" Name="ServiceContractModelHasServiceContracts" DisplayName="Service Contract Model Has Service Contracts" Namespace="Microsoft.Practices.ServiceFactory.ServiceContracts" IsEmbedding="true">
      <Source>
        <DomainRole Id="9e8820d7-e00c-484a-9b39-1ee0e307510e" Description="" Name="ServiceContractModel" DisplayName="Service Contract Model" PropertyName="ServiceContracts" Category="General" PropertyDisplayName="Service Contracts">
          <RolePlayer>
    ...
    <DomainRelationship Id="9810bec1-75ca-4600-847f-7e32604c2531" Description="Description for Microsoft.Practices.ServiceFactory.ServiceContracts.ServiceContractModelHasOperations" Name="ServiceContractModelHasOperations" DisplayName="Service Contract Model Has Operations" Namespace="Microsoft.Practices.ServiceFactory.ServiceContracts" IsEmbedding="true">
      ...
      <Target>
        <DomainRole Id="fb4a732f-79c8-4576-8fad-0e13b46cfa32" Description="Description for Microsoft.Practices.ServiceFactory.ServiceContracts.ServiceContractModelHasOperations.Operation" Name="Operation" DisplayName="Operation" PropertyName="ServiceContractModel" Multiplicity="One" PropagatesDelete="true" PropagatesCopy="true" Category="General" PropertyDisplayName="Service Contract Model">
          <RolePlayer>
            <DomainClassMoniker Name="Operation" />
          </RolePlayer>
        </DomainRole>
    ...
    <DomainRelationship Id="a95f0175-0f05-4a6e-80ba-9949cf8267a7" Description="Description for Microsoft.Practices.ServiceFactory.ServiceContracts.ServiceContractModelHasServices" Name="ServiceContractModelHasServices" DisplayName="Service Contract Model Has Services" Namespace="Microsoft.Practices.ServiceFactory.ServiceContracts" IsEmbedding="true">
      <Source>
        <DomainRole Id="f5e8c9e2-66a4-44ae-abed-2119b3e49b63" Description="Description for Microsoft.Practices.ServiceFactory.ServiceContracts.ServiceContractModelHasServices.ServiceContractModel" Name="ServiceContractModel" DisplayName="Service Contract Model" PropertyName="Services" Category="General" PropertyDisplayName="Services">
          <RolePlayer>
            <DomainClassMoniker Name="ServiceContractModel" />
          </RolePlayer>
        </DomainRole>
      ...
      <Target>
        <DomainRole Id="95c39005-60a2-479a-ac80-e3606d8bdb4c" Description="Description for Microsoft.Practices.ServiceFactory.ServiceContracts.ServiceContractModelHasServices.Service" Name="Service" DisplayName="Service" PropertyName="ServiceContractModel" Multiplicity="One" PropagatesDelete="true" PropagatesCopy="true" Category="General" PropertyDisplayName="Service Contract Model">
          <RolePlayer>
            <DomainClassMoniker Name="Service" />
          </RolePlayer>
        </DomainRole>
    ...
    <DomainRelationship Id="780f41e2-b2eb-43e4-9797-1d4d6ed0ca84" Description="Description for Microsoft.Practices.ServiceFactory.ServiceContracts.OperationHasFaults" Name="OperationHasFaults" DisplayName="Operation Has Faults" Namespace="Microsoft.Practices.ServiceFactory.ServiceContracts" IsEmbedding="true">
      <Source>
        <DomainRole Id="bfcabfa4-2cdb-4b90-bb4b-eb5753e46720" Description="Description for Microsoft.Practices.ServiceFactory.ServiceContracts.OperationHasFaults.Operation" Name="Operation" DisplayName="Operation" PropertyName="Faults" Category="General" PropertyDisplayName="Faults">
          <RolePlayer>
            <DomainClassMoniker Name="Operation" />
          </RolePlayer>
        </DomainRole>
      ...
      <Target>
        <DomainRole Id="f167f11b-328d-43ae-841e-90b25ddff053" Description="Description for Microsoft.Practices.ServiceFactory.ServiceContracts.OperationHasFaults.Fault" Name="Fault" DisplayName="Fault" PropertyName="Operation" Multiplicity="One" PropagatesDelete="true" PropagatesCopy="true" Category="General" PropertyDisplayName="Operation">
          <RolePlayer>
            <DomainClassMoniker Name="Fault" />
          </RolePlayer>
        </DomainRole>
    ...
    <DomainRelationship Id="46173368-dadd-4e71-b51f-780ba06e1111" Description="Description for Microsoft.Practices.ServiceFactory.ServiceContracts.ServiceContractModelHasMessages" Name="ServiceContractModelHasMessages" DisplayName="Service Contract Model Has Messages" Namespace="Microsoft.Practices.ServiceFactory.ServiceContracts" IsEmbedding="true">
      <Source>
        <DomainRole Id="feb77b0a-97f7-4672-8d85-a8898cab21c2" Description="Description for Microsoft.Practices.ServiceFactory.ServiceContracts.ServiceContractModelHasMessages.ServiceContractModel" Name="ServiceContractModel" DisplayName="Service Contract Model" PropertyName="Messages" Category="General" PropertyDisplayName="Messages">
          <RolePlayer>
            <DomainClassMoniker Name="ServiceContractModel" />
          </RolePlayer>
        </DomainRole>
    ...
    <DomainRelationship Id="ebb784ad-4d26-4df2-81fc-5d4fa935b63b" Description="Description for Microsoft.Practices.ServiceFactory.ServiceContracts.MessageHasMessageParts" Name="MessageHasMessageParts" DisplayName="Message Has Message Parts" Namespace="Microsoft.Practices.ServiceFactory.ServiceContracts" IsEmbedding="true">
      <Source>
        <DomainRole Id="7f4f7430-6088-4035-ae29-fbb5ac17cbd3" Description="Description for Microsoft.Practices.ServiceFactory.ServiceContracts.MessageHasMessageParts.MessageBase" Name="MessageBase" DisplayName="Message Base" PropertyName="MessageParts" Category="General" PropertyDisplayName="MessageParts">
          <RolePlayer>
            <DomainClassMoniker Name="MessageBase" />
          </RolePlayer>
        </DomainRole>
      ...
      <Target>
        <DomainRole Id="5659501f-e9bf-4314-b48d-108a17271b40" Description="A cross-model reference to the associated data contract type on the data contract model." Name="MessagePart" DisplayName="Message" PropertyName="Message" Multiplicity="One" PropagatesDelete="true" PropagatesCopy="true" Category="General" PropertyDisplayName="Message">
          <RolePlayer>
            <DomainClassMoniker Name="MessagePart" />
          </RolePlayer>
        </DomainRole>
  ...
  <XmlSerializationBehavior Name="ServiceContractDslSerializationBehavior" Namespace="Microsoft.Practices.ServiceFactory.ServiceContracts">
    <ClassData>
      ...
      <XmlClassData TypeName="ServiceContract" MonikerAttributeName="name" MonikerElementName="serviceContractMoniker" ElementName="serviceContract" MonikerTypeName="ServiceContractMoniker">
        <DomainClassMoniker Name="ServiceContract" />
        <ElementData>
      ...
      <XmlClassData TypeName="DataContractMessagePart" MonikerAttributeName="" MonikerElementName="dataContractMessagePartMoniker" ElementName="dataContractMessagePart" MonikerTypeName="DataContractMessagePartMoniker">
        <DomainClassMoniker Name="DataContractMessagePart" />
        <ElementData>
      ...
      <XmlClassData TypeName="PrimitiveMessagePart" MonikerAttributeName="" MonikerElementName="primitiveMessagePartMoniker" ElementName="primitiveMessagePart" MonikerTypeName="PrimitiveMessagePartMoniker">
        <DomainClassMoniker Name="PrimitiveMessagePart" />
        <ElementData>
          <XmlPropertyData XmlName="type">
      ...
      <XmlClassData TypeName="MessageBase" MonikerAttributeName="" SerializeId="true" MonikerElementName="messageBaseMoniker" ElementName="messageBase" MonikerTypeName="MessageBaseMoniker">
        <DomainClassMoniker Name="MessageBase" />
        <ElementData>
          <XmlPropertyData XmlName="name">
      ...
      <XmlClassData TypeName="DataContractFault" MonikerAttributeName="" MonikerElementName="dataContractFaultMoniker" ElementName="dataContractFault" MonikerTypeName="DataContractFaultMoniker">
  ...
  <Diagram Id="a41ec408-78bc-4bb2-80b6-9717d7d24b04" Description="Description for Microsoft.Practices.ServiceFactory.ServiceContracts.ServiceContractDiagram" Name="ServiceContractDiagram" DisplayName="Service Contract Diagram" Namespace="Microsoft.Practices.ServiceFactory.ServiceContracts">
    <Class>
      <DomainClassMoniker Name="ServiceContractModel" />
    </Class>
    <ShapeMaps>
  ...
  <Designer FileExtension="servicecontract" EditorGuid="74a1ee75-1c00-4e23-9e74-1e24af934cfd">
    <RootClass>
      <DomainClassMoniker Name="ServiceContractModel" />
    </RootClass>
