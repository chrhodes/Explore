Partial Public Class ComboBoxEditor

    Private Sub ComboBoxEditor_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
