Partial Public Class CheckBoxEditor

    Private Sub CheckBoxEditor_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
