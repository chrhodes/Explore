Partial Public Class DatePickerEditor

    Private Sub DatePickerEditor_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
