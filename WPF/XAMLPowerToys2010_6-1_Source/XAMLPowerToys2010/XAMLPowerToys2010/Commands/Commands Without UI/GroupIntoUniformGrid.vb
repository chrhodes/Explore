...
Public Class GroupIntoUniformGrid
...
#Region " Constructors "
    ...
    Public Sub New(ByVal objAddInInstance As AddIn, ByVal objApplication As DTE2, ByVal intCounter As Integer)
        ...
        MyBase.Caption = "UniformGrid"
        MyBase.CommandName = "GroupIntoUniformGridCommand" & intCounter.ToString
        MyBase.ToolTip = "Group selection into a uniformgrid."
    End Sub
...
#Region " Methods "
    ...
    Public Overrides Sub Execute()
        ...
        Try
            GroupInto("<UniformGrid>", "</UniformGrid>")
