...
Public Class GroupIntoBorderNoChildRoot
...
#Region " Constructors "
    ...
    Public Sub New(ByVal objAddInInstance As AddIn, ByVal objApplication As DTE2, ByVal intCounter As Integer)
        ...
        MyBase.Caption = "Border Without Child Root"
        MyBase.CommandName = "GroupIntoBorderNoChildRootCommand" & intCounter.ToString
        MyBase.ToolTip = "Group selection into a border without an additional root child being added."
    End Sub
