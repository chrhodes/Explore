...
Public Class GroupIntoDockPanel
...
#Region " Constructors "
    ...
    Public Sub New(ByVal objAddInInstance As AddIn, ByVal objApplication As DTE2, ByVal intCounter As Integer)
        ...
        MyBase.Caption = "DockPanel"
        MyBase.CommandName = "GroupIntoDockPanelCommand" & intCounter.ToString
        MyBase.ToolTip = "Group selection into a dockpanel."
    End Sub
