...
Public Class GroupIntoGroupBox
...
#Region " Constructors "
    ...
    Public Sub New(ByVal objAddInInstance As AddIn, ByVal objApplication As DTE2, ByVal intCounter As Integer)
        ...
        MyBase.Caption = "GroupBox With Root Grid"
        MyBase.CommandName = "GroupIntoGroupBoxCommand" & intCounter.ToString
        MyBase.ToolTip = "Group selection into a GroupBox with root grid being added."
    End Sub
...
#Region " Methods "
    ...
    Public Overrides Sub Execute()
        ...
        Try
            GroupInto(String.Concat("<GroupBox>", vbCrLf, "<Grid>", vbCrLf), String.Concat("</Grid>", vbCrLf, "</GroupBox>", vbCrLf))
