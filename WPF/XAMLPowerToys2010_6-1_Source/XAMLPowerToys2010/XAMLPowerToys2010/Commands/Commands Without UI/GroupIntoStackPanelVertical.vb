...
Public Class GroupIntoStackPanelVertical
...
#Region " Constructors "
    ...
    Public Sub New(ByVal objAddInInstance As AddIn, ByVal objApplication As DTE2, ByVal intCounter As Integer)
        ...
        MyBase.Caption = "StackPanel - Vertical"
        MyBase.CommandName = "GroupIntoStackPanelVerticalCommand" & intCounter.ToString
        MyBase.ToolTip = "Group selection into a stackpanel - vertical."
    End Sub
...
#Region " Methods "
    ...
    Public Overrides Sub Execute()
        ...
        Try
            GroupInto("<StackPanel>", "</StackPanel>")
