...
Public Class GroupIntoBorderWithGridRoot
...
#Region " Constructors "
    ...
    Public Sub New(ByVal objAddInInstance As AddIn, ByVal objApplication As DTE2, ByVal intCounter As Integer)
        ...
        MyBase.Caption = "Border With Root Grid"
        MyBase.CommandName = "GroupIntoBorderRootGridCommand" & intCounter.ToString
        MyBase.ToolTip = "Group selection into a border with root grid being added."
    End Sub
...
#Region " Methods "
    ...
    Public Overrides Sub Execute()
        ...
        Try
            GroupInto(String.Concat("<Border>", vbCrLf, "<Grid>", vbCrLf), String.Concat("</Grid>", vbCrLf, "</Border>", vbCrLf))
