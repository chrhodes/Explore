...
#Region " Constructors "
    ...
    Public Sub New(ByVal objAddInInstance As AddIn, ByVal objApplication As DTE2, ByVal intCounter As Integer)
        ...
        MyBase.Caption = "Canvas"
        MyBase.CommandName = "GroupIntoCanvasCommand" & intCounter.ToString
        MyBase.ToolTip = "Group selection into a canvas."
    End Sub
