...
Public Class GroupIntoScrollViewer
...
#Region " Constructors "
    ...
    Public Sub New(ByVal objAddInInstance As AddIn, ByVal objApplication As DTE2, ByVal intCounter As Integer)
        ...
        MyBase.Caption = "ScrollViewer With Root Grid"
        MyBase.CommandName = "GroupIntoScrollViewerCommand" & intCounter.ToString
        MyBase.ToolTip = "Group selection into a scrollviewer with root grid being added."
    End Sub
...
#Region " Methods "
    ...
    Public Overrides Sub Execute()
        ...
        Try
            GroupInto(String.Concat("<ScrollViewer>", vbCrLf, "<Grid>", vbCrLf), String.Concat("</Grid>", vbCrLf, "</ScrollViewer>", vbCrLf))
