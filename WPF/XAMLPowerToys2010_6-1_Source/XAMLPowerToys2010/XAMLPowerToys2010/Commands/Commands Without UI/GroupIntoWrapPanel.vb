...
Public Class GroupIntoWrapPanel
...
#Region " Constructors "
    ...
    Public Sub New(ByVal objAddInInstance As AddIn, ByVal objApplication As DTE2, ByVal intCounter As Integer)
        ...
        MyBase.Caption = "WrapPanel"
        MyBase.CommandName = "GroupIntoWrapPanelCommand" & intCounter.ToString
        MyBase.ToolTip = "Group selection into a wrappanel."
    End Sub
