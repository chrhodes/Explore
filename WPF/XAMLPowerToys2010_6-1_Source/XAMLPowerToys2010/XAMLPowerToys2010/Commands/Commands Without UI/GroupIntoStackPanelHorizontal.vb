...
Public Class GroupIntoStackPanelHorizontal
...
#Region " Constructors "
    ...
    Public Sub New(ByVal objAddInInstance As AddIn, ByVal objApplication As DTE2, ByVal intCounter As Integer)
        ...
        MyBase.Caption = "StackPanel - Horizontal"
        MyBase.CommandName = "GroupIntoStackPanelHorizontalCommand" & intCounter.ToString
        MyBase.ToolTip = "Group selection into a stackpanel - horizontal."
    End Sub
...
#Region " Methods "
    ...
    Public Overrides Sub Execute()
        ...
        Try
            GroupInto("<StackPanel Orientation=""Horizontal"">", "</StackPanel>")
