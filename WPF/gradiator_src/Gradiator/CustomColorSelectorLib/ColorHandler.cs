...
namespace ColorPickerControlLib.ColorPicker
{
    public class ColorHandler
    {
        ...
        public static RGB HSVtoRGB(int A, int H, int S, int V)
        {
            // H must be between 0 and 360,  and S, and V must be between 0 and 255.
        ...
        public static RGB HSVtoRGB(HSV HSV)
        {
            ...
            return new RGB(HSV.Alpha, (int)(r * 255), (int)(g * 255), (int)(b * 255));
        }
        ...
        public static HSV RGBtoHSV(RGB RGB)
        {
            ...
            return new HSV(RGB.Alpha, (int)(h / 360 * 255), (int)(s * 255), (int)(v * 255));
        }
    }
}