...
{
    public abstract class DetailViewModelBase15 : ViewModelBase, IDetailViewModel
    {
        protected readonly IEventAggregator EventAggregator;
        private bool _hasChanges;
        private static int _instanceCountDVM = 0;

        public DetailViewModelBase15(IEventAggregator eventAggregator)
        {
            _instanceCountDVM++;
        ...
        {
            EventAggregator.GetEvent<AfterDetailDeletedEvent15>()
                .Publish
                (
        ...
        {
            EventAggregator.GetEvent<AfterDetailSavedEvent15>()
                .Publish
                (
