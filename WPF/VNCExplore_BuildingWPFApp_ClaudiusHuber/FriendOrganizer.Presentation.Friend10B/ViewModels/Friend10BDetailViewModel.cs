...
{
    class Friend10BDetailViewModel : ViewModelBase, IFriend10BDetailViewModel
    {

        private static int _instanceCountDVM = 100;
        private IEventAggregator _eventAggregator;
        private Friend10BWrapper _friend;
        private IFriendRepository10 _friendRepository;
        bool _hasChanges;

        public Friend10BDetailViewModel(
        ...
        public Friend10BWrapper Friend
        {
            get { return _friend; }
            private set
            {
        ...
        public async Task LoadAsync(int friendId)
        {
            ...
            Friend = new Friend10BWrapper(friend);
