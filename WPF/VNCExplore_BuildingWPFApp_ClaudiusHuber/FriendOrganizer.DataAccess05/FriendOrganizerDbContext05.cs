...
{
    public class FriendOrganizerDbContext05 : DbContext
    {
        public FriendOrganizerDbContext05() : base("VNCFriendOrganizerDB")
        {

        }

        public DbSet<Friend05> Friends05 { get; set; }
        public DbSet<ProgrammingLanguage12> ProgrammingLanguages { get; set; }
