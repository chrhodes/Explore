...
{
    internal class Meeting17DetailViewModel : DetailViewModelBase17, IMeeting17DetailViewModel
    {
        private static int _instanceCountDVM = 100;
        private Meeting17Wrapper _meeting;
        ...
        public Meeting17DetailViewModel(
            ...
            : base(eventAggregator, messageDialogService)
        {
            ...
            eventAggregator.GetEvent<AfterDetailSavedEvent17>()
                .Subscribe(AfterDetailSaved);
            eventAggregator.GetEvent<AfterDetailDeletedEvent17>()
        ...
        {
            if (args.ViewModelName == nameof(Friend17DetailViewModel))
            {
        ...
        public Meeting17Wrapper Meeting
        {
            get { return _meeting; }
            private set
            {
        ...
        {
            Meeting = new Meeting17Wrapper(meeting);
