...
Namespace WpfWithWFAndDataBinding
	...
	Partial Public Class MainWindow
		...
		Private Sub WindowLoaded(ByVal sender As Object, ByVal e As RoutedEventArgs)
			...
			Dim cv As BindingListCollectionView = TryCast(CollectionViewSource.GetDefaultView(Me.nwBindingSource), BindingListCollectionView)
		...
		Private Sub WPF_CurrentChanged(ByVal sender As Object, ByVal e As EventArgs)
			Dim cv As BindingListCollectionView = TryCast(sender, BindingListCollectionView)
