...
namespace VNCExplore_LearnPrism_MultipleShells_BrianLagunas
{
    public class Common
    {
        public const string PROJECT_NAME = "VNCExplore_LearnPrism_BrianLagunas";
        public const string LOG_APPNAME = "VNCExplore_LearnPrism_BrianLagunas";
        public const string APPNAME = "EASE VNCExplore_LearnPrism_BrianLagunas Console";

        public const string cCONFIG_FILE = @"C:\temp\VNCExplore_LearnPrism_BrianLagunas.xml";
