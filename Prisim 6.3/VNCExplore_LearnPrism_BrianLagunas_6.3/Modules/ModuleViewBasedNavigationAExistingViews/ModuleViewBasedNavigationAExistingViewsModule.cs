...
namespace ModuleViewBasedNavigationAExistingViews
{
    public class ModuleViewBasedNavigationAExistingViewsModule : ModuleBase
    {
        public ModuleViewBasedNavigationAExistingViewsModule(IUnityContainer container, IRegionManager regionManager)
        ...
        {
            RegionManager.RegisterViewWithRegion(RegionNames.ToolBarRegionN_VB_EV, typeof(ViewA1Button));
