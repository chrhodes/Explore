...
namespace ModulePeopleDelegateCommand
{
    public class PersonViewModel : ViewModelBase, IPersonViewModel
    {
            ...
            : base(view)
        {
            ...
            SaveCommandofT = new DelegateCommand<PrismDemo.Business.Person>(Save, CanSave);
        }
        ...
        private void Person_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            SaveCommandofT.RaiseCanExecuteChanged();
        }
        ...
        public DelegateCommand<PrismDemo.Business.Person> SaveCommandofT { get; set; }
