...
{
    public class ModuleViewBasedNavigationAConfirmCancelModule : ModuleBase
    {
        public ModuleViewBasedNavigationAConfirmCancelModule(IUnityContainer container, IRegionManager regionManager)
        ...
        {
            RegionManager.RegisterViewWithRegion(RegionNames.ToolBarRegionN_VB_CC, typeof(ViewA1Button));
