...
{
    public class ModulePeopleSharedServiceModule : IModule
    {
        private readonly IRegionManager _regionManager;
        private readonly IUnityContainer _container;

        public ModulePeopleSharedServiceModule(IUnityContainer container, IRegionManager regionManager)
        {
        ...
        public void Initialize()
        {
            ...
            IRegion region = _regionManager.Regions[RegionNames.ContentRegionC_SS];
