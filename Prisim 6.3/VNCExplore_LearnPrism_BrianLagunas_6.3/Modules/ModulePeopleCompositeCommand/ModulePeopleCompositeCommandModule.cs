...
namespace ModulePeopleCompositeCommand
{
    public class ModulePeopleCompositeCommandModule : IModule
    {
        private readonly IRegionManager _regionManager;
        private readonly IUnityContainer _container;

        public ModulePeopleCompositeCommandModule(IUnityContainer container, IRegionManager regionManager)
        {
