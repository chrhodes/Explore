...
{
    class Concurrent_M5_SalesBonuses : Page
    {
		public static readonly List<string> AllShirtNames = new List<string>
		{ "technologyhour", "Code School", "jDays", "buddhistgeeks", "iGeek" };

		public Concurrent_M5_SalesBonuses(Program program) : base("Concurrent_M5_SalesBonuses", program)
        {
        }
        ...
        public override void Display()
        {
            ...
            Output.WriteLine("Hello from Concurrent_M5_SalesBonuses");
