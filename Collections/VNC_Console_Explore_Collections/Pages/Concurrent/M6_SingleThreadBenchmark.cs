...
{
    class M6_SingleThreadBenchmark : Page
    {
        public M6_SingleThreadBenchmark(Program program) : base("M6_SingleThreadBenchmark", program)
        {
        }
        ...
        public override void Display()
        {
            ...
            Output.WriteLine("Hello from M6_SingleThreadBenchmark");
        ...
        void Benchmark()
        {
            ...
            SingleThreadBenchmarkM6.TimeDict(dict, dictSize);
        }
    }
}
