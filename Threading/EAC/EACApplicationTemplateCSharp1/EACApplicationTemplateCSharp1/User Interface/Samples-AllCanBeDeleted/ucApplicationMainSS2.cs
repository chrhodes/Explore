...
{
    public partial class ucApplicationMainSS2 : ucScreenBase
    {
        const string CONTROL_NAME = "ucApplicationMainSS2";

        #region Initialization

        public ucApplicationMainSS2()
        {
#if TRACE
        ...
        private void btnGotoApplicationMain_Click_1(object sender, EventArgs e)
        {
            GoToApplicationMain();
        }
        ...
        {
            SwapUserControl(this, System.Type.GetType("EACApplicationTemplateCSharp1.User_Interface.ucApplicationMain"));
        }
