    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BabyStore.DAL.StoreContext>
    {
        ...
        protected override void Seed(BabyStore.DAL.StoreContext context)
        {
            ...
            var products = new List<Product>
            {
                ...
                new Product { Name = "Blue Rabbit", Description = "Baby comforter",
                                Price = 2.99M, CategoryID = categories.Single(c => c.Name == "Play and Toys").ID },
                ...
                new Product { Name = "Crib", Description="Wooden crib",
