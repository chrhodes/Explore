...
namespace PrismDemo.DomainServices.PersonService
{
    ...
    {
        private static readonly string Avatar1Uri = @"/PrismDemo.Services.PersonService;component/Images/MC900432625.PNG";
        private static readonly string Avatar2Uri = @"/PrismDemo.Services.PersonService;component/Images/MC900433938.PNG";
        ...
        public IList<Business.Person> GetPeople()
        {
            ...
            for (int i = 0; i < 50; i++)
            {
                ...
                people.Add(person);
                Thread.Sleep(50); //simulate longer process
            }
