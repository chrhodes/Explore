...
namespace ModuleC
{
    public class ModuleCModule : IModule
    {
        ...
        public void OnInitialized(IContainerProvider containerProvider)
        {
            ...
            regionManager.RegisterViewWithRegion(RegionNames.ToolBarRegionC, typeof(ToolBarView));
            regionManager.RegisterViewWithRegion(RegionNames.ContentRegionC, typeof(ContentView));
