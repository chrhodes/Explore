...
{
    public class ModuleViewBasedNavigationBPassingParametersModule : ModuleBase
    {
        public ModuleViewBasedNavigationBPassingParametersModule(IUnityContainer container, IRegionManager regionManager)
        ...
        {
            RegionManager.RegisterViewWithRegion(RegionNames.ToolBarRegionN_VB_PP, typeof(ViewB1Button));;
        }
