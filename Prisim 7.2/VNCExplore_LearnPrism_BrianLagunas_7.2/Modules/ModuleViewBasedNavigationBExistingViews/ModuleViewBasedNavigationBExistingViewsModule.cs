...
namespace ModuleViewBasedNavigationBExistingViews
{
    public class ModuleViewBasedNavigationBExistingViewsModule : ModuleBase
    {
        public ModuleViewBasedNavigationBExistingViewsModule(IUnityContainer container, IRegionManager regionManager)
        ...
        {
            RegionManager.RegisterViewWithRegion(RegionNames.ToolBarRegionN_VB_EV, typeof(ViewB1Button));;
        }
